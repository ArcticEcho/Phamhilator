...
//        public static bool SystemIsFunctional
//        {
//            get
//            {
...
//        {
//            if (!SystemIsFunctional || !ID.All(Char.IsDigit) || UserAccess.Owners.Any(user => user.ID == int.Parse(ID))) { return false; }
...
//        {
//            if (!SystemIsFunctional || !ID.All(Char.IsDigit)) { return true; }
...
//        {
//            return Encoding.UTF8.GetBytes("samunifoxphamghamyam");
//        }
//    }
//}
